...
本システムには、残念なポケモン図鑑、最強剣一覧、特殊羽一覧、残念なポケモン図鑑クイズの4つの機能が統合されている．
...
とを目的としている．残念なポケモン図鑑クイズでは，図鑑の辛辣な説明文だけを提示し，それがどのポケモンの説明かを4択で
当てさせることで，残念なポケモン図鑑のコンテンツをより楽しんでもらうことを目的としている．
本クイズは，正解のポケモンIDをクライアント側に渡さず，サーバーが発行したトークンに正解を紐づけて保持し，
採点もサーバー側で行う設計とした．これにより，クライアントだけでは正解を知ることができず，
サーバーが無ければ遊べない仕組みとなっており，サーバーとクライアントが協調して動作する本課題の趣旨を満たしている．
...
\begin{itemize}
  ...
  \item 残念なポケモン図鑑クイズ: \url{http://20.214.236.18:8080/pokemonquiz}
\end{itemize}
