...
本システムには、残念なポケモン図鑑、最強剣一覧、特殊羽一覧、マインスイーパーの4つの機能が統合されている．
残念なポケモン図鑑では本システムでは，ポケモンのコンテンツでは多く存在する図鑑説明が辛辣なポケモンを集め，
...
とを目的としている．マインスイーパーは，ユーザがブラウザ上でマインスイーパーを楽しむことができるようにすることを目的としている．
...
\begin{itemize}
  ...
  \item マインスイーパー: \url{http://20.214.236.18:8080/minesweeper/}
\end{itemize}
