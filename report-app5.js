// ============================================================
//  サーバー側プログラム（本科目レポート用・抜粋）
//   ポケモン図鑑 / 最強剣 / 特殊羽 の各一覧を 1 つのサーバーで配信する。
//   Azure VM 上で pm2 により常駐させ、URL でアクセスできるようにしている。
//   ※ 本番の app5.js から、本科目に無関係な機能（駅一覧・練習課題）を除いた版。
// ============================================================
"use strict";
